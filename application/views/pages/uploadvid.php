...
<br /><br />
	...
	<?php echo form_open_multipart(site_url('submit/index/2'),'class="form"');
		...
		echo '<div class="inpWrap"><label>Upload video</label>'. form_upload('video','','class="file_upload"').'</div>';
