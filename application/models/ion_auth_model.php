...
class Ion_auth_model extends CI_Model
{
	...
	public function get_user($id){
		$query = $this->db->select('id as user_id, username as user_name, first_name, last_name, email')
						->get_where('admin_users', array('id' => $id));
		return $query->row();
	}
	
	public function update_user($id, $update_data){
		$this->db->update('admin_users', $update_data, array('id' => $id));
		return TRUE;
	}
